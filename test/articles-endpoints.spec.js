...
describe.only('Articles Endpoint', function() {
      ...
      context(`Given no articles`, () => {
          it(`responds with 404`, () => {
              ...
              return supertest(app)
                  ...
                  .expect(404, { error: { message: `Article dosn't exist` } })
          })
      })
      context('Given there are articles in the database', () => {
        const testUsers = makeUsersArray();
    ...
    describe('POST /api/articles', () => {
      it('creates an article and returns 201 and the new article', () => {
        const newArticle = {
      ...
      const requireFields = ['title', 'style', 'content']
      ...
      context(`Given there are articles in the database`, () => {
        ...
        it(`responds with 400 when no required fields are supplied`, () => {
          ...
          return supertest(app)
            ...
            .expect(400, { error: { message: `Request body must contain either 'title', 'content', or 'style'` } })
        })
